...
Analyzes the Husky- constraint system to identify jumping/instability issues
"""
...
def analyze_constraint_system():
    ...
    print("   2.  Arm: '_iiwa/model_free_base.urdf' - SEPARATE URDF")
    ...
    print("   ❌ Mass imbalance: 30kg Husky + 15kg  + arm masses")
    ...
    solutions = [
        ...
        ("UNIFIED", "Create single URDF with Husky+ as one robot"),
